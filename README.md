...
If you are using this library in one of your projects, add it in this list. :sparkles:
 ...
 - [`bhedge`](https://github.com/bhedge/node-card#readme) (by Brandon Hedge)—Contact card for @bhedge
 ...
 - [`ducksay-instant`](https://npmjs.com/package/ducksay-instant) (by Kyle Graves)—A rewrite of cowsay using the DuckDuckGo Instant Answer API
 ...
 - [`gem-mine`](https://npmjs.com/package/gem-mine) (by 洪军钊)—a fantastic react boilerplate
 - [`ghcal`](https://github.com/IonicaBizau/ghcal)—See the GitHub contributions calendar of a user in the command line.
 - [`js-kapela`](https://github.com/kapela-project/js-kapela#readme) (by Killian Alawi)—Peer-to-peer messaging app
 ...
 - [`survivio`](https://github.com/grant/node-survivio#readme) (by Grant Timmerman)—An API for surviv.io
